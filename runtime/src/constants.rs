...
pub const MAX_COLLATOR_STAKE: Balance = 200_000 * KAB;

/// One KAB
pub const KAB: Balance = 10u128.pow(15);

/// 0.001 KAB
pub const MILLI_KAB: Balance = 10u128.pow(12);

/// 0.000_001 KAB
pub const MICRO_KAB: Balance = 10u128.pow(9);
...
pub fn kab_inflation_config() -> InflationInfo {
	InflationInfo::new(
		BLOCKS_PER_YEAR,
		// max collator staking rate
		Perquintill::from_percent(40),
...
pub const fn deposit(items: u32, bytes: u32) -> Balance {
	items as Balance * 56 * MILLI_KAB + (bytes as Balance) * 50 * MICRO_KAB
}
...
parameter_types! {
	...
	pub const MinVestedTransfer: Balance = 100 * MILLI_KAB;
	/// Deposits per byte
	...
	pub const CtypeFee: Balance = MILLI_KAB;
}
...
pub mod delegation {
	...
	pub const DELEGATION_DEPOSIT: Balance = KAB;
...
pub mod governance {
	...
	pub const MIN_DEPOSIT: Balance = KAB;
...
pub mod did {
	...
	pub const DID_FEE: Balance = 50 * MILLI_KAB;
...
pub mod treasury {
	...
	const YEARLY_REWARD: Balance = 2_000_000u128 * KAB;
...
pub mod fee {
	...
	parameter_types! {
		...
		pub const TransactionByteFee: Balance = MICRO_KAB;
	}
}
